...
while billing:                            #outer while -- on customer per loop
    ...
    while item_number <= item_count:          #inner while -- on item per loop 
    ...
    for slot in range(1, 4):
        # outer for -- one price category per loop
        if slot == 1:
